    ...
    plugins: [
      alias({
        entries: [
          {
            find: 'App',
            replacement: path.resolve(__dirname, 'source', 'App'),
          },
          {
            find: 'Components',
            replacement: path.resolve(__dirname, 'source', 'Components'),
          },
          {
            find: 'Utilities',
            replacement: path.resolve(__dirname, 'source', 'Utilities'),
          },
          {
            find: 'Styles',
            replacement: path.resolve(__dirname, 'source', 'Styles'),
          },
          {
            find: 'Assets',
