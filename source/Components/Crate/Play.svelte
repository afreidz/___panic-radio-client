  ...
  <div class="content">
    ...
    <ul class="items">
      ...
      <li class="item">
        ...
        <div class="action">
          <PanicButton on:click={() => play(entry)}><i>▶</i> play</PanicButton>
        </div>
      </li>
      {/each}
    </ul>
...
<style lang="less">
  ...
  .tip {
    ...
    strong, small { font-size: unit(14px/@one-rem, rem); }
    span { font-size: 2rem; font-weight: 900; margin: 0.5rem auto; }
  }
  .items {
    flex-grow: 1;
    overflow-y: auto;
  ...
  .action { 
    ...
    i { display: inline-block; vertical-align: middle; font-size: unit(8px/@one-rem, rem); }
  }
</style>
